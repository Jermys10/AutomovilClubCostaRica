namespace AutomovilClub.Backend.Helpers
{
    ...
    public class UserHelper : IUserHelper
    {
        ...
        public async Task<User> AddUserAsync(AddUserViewModel model, string image, Role role)
        {
            User user = new User()
            {
            ...
            await AddUserToRoleAsync(newUser, user.Role.ToString());
            return newUser;
        }
        ...
        public async Task<IdentityResult> UpdateUserAsync(User user)
        {
            ...
            currentUser.IsDelete = user.IsDelete;
            //await ChangePasswordAsync(currentUser, currentUser.Password, user.Password);
